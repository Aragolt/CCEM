package theovergrown.characters;
...
import static theovergrown.theovergrown.*;
import static theovergrown.characters.TheOvergrown.Enums.EV_BLUE;

public class TheOvergrown extends CustomPlayer {
    public static final Logger logger = LogManager.getLogger(theovergrown.class.getName());

    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_OVERGROWN;
    ...
    private static final String ID = makeID("OGCharacter");
    private static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    private static final String[] NAMES = characterStrings.NAMES;
    private static final String[] TEXT = characterStrings.TEXT;

    public static final String[] orbTextures = {
            "theextravagantResources/eimages/char/defaultCharacter/orb/layer1.png",
    ...
    public TheOvergrown(String name, PlayerClass setClass) {
        super(name, setClass, orbTextures,
                "theovergrownResources/img/char/defaultCharacter/orb/vfx.png", null,
                new SpriterAnimation(
                        "theovergrownResources/img/char/defaultCharacter/Spriter/theDefaultAnimation.scml"));
    ...
    public AbstractPlayer newInstance() {
        return new TheOvergrown(name, chosenClass);
    }
